...
public class IAPKey
{
    ...
    public const string PACK3_REGISTER = "game3_register_3_sleepsound";
    public const string PACK4_REGISTER = "game3_register_4_sleepsound";
    public const string PACK5_REGISTER = "game3_register_5_sleepsound";
}
